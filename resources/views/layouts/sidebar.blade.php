...
<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        ...
        <a href="{{ route('root') }}" class="logo logo-light">
            <span class="logo-sm">
                <h3 class="text-white m-3">B</h3>
                {{-- <img src="{{ URL::asset('build/images/logo-sm.png') }}" alt="" height="22"> --}}
            </span>
            <span class="logo-lg">
                <h3 class="text-white m-3">Bagodara Truck plaza</h3>
    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route('entry-booking.index') }}" >
                        <i class="ri-layout-grid-line"></i> <span>@lang('translation.vehicle_entry')</span>
                    </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route('exit-booking.index') }}" >
                        <i class="ri-layout-grid-line"></i> <span>@lang('translation.vehicle_exit')</span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarMaster" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarMaster">
                        <i class="ri-layout-3-line"></i> <span>@lang('translation.master')</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarMaster">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{ route('city.list') }}"  class="nav-link">@lang('translation.city')</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('state.list') }}"  class="nav-link">@lang('translation.state')</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('country.list') }}"  class="nav-link">@lang('translation.country')</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('parking.list') }}"  class="nav-link">@lang('translation.parking')</a>
                            </li>

                            {{-- <li class="nav-item">
                                <a href="layouts-vertical-hovered"  class="nav-link">@lang('translation.hovered')</a>
                            </li> --}}
                        </ul>
                    </div>
                </li> <!-- end Dashboard Menu -->
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#bookingTab" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="bookingTab">
                        <i class="ri-layout-grid-line"></i> <span>@lang('translation.slot_master')</span>
                    </a>
                    <div class="collapse menu-dropdown" id="bookingTab">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{ route('slot.index') }}" class="nav-link">@lang('translation.list_slot_master')</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('slot.create') }}" class="nav-link">@lang('translation.add_slot_master')</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route('parking_slots.list') }}" >
                        <i class="ri-layout-grid-line"></i> <span>@lang('translation.parking_slot')</span>
                    </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route('vehicle-models.index') }}" >
                        <i class="ri-layout-grid-line"></i> <span>@lang('translation.vehicle_model')</span>
                    </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route('number-plate.index') }}" >
                        <i class="ri-layout-grid-line"></i> <span>@lang('translation.number_plate')</span>
                    </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route('driver-and-cleaner.index') }}" >
                        <i class="ri-layout-grid-line"></i> <span>@lang('translation.driver_cleaner')</span>
                    </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route('slots-pricing.index') }}" >
                        <i class="ri-layout-grid-line"></i> <span>@lang('translation.slot_pricing')</span>
                    </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route('user.index') }}" >
                        <i class="ri-layout-grid-line"></i> <span>@lang('translation.user_master')</span>
                    </a>
                </li>
