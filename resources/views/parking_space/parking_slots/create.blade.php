                ...
                <div class="card-body">
                    <div class="live-preview">
                        <div class="row gy-4">
                            ...
                            <div class="col-md-6">
                                <div>
                                    {!! Form::label('parking_id', 'Select Parking', ['class' => 'form-label']) !!}

                                    {!! Form::select('parking_id', $parkings, null, ['id' => 'state-select', 'placeholder' => 'Select Parking','class' => 'form-select','required']) !!}
                                </div>
                            </div>
