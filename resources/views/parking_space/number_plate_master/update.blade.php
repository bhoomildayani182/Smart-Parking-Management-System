...
@slot('title') Update Number Plate @endslot
@endcomponent

{{-- {!! Form::model($numberPlate,[
    'route' => ['number-plate.update',$numberPlate->id],
    'method' => 'put',
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-md-6">
                                <div>
                                    ...
                                    {!! Form::text('group_of_letter', old('group_of_letter'), ['class' => 'form-control', 'required']) !!}
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div>
                                    ...
                                    {!! Form::select('state', $states,  $numberPlate->state_id  , ['id' => 'state-select', 'placeholder' => 'Select State','class' => 'form-select','required']) !!}
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div>
                                    ...
                                    {!! Form::text('city_number', old('city_number') , ['class' => 'form-control', 'required']) !!}
                                </div>
                            </div>
...
<script>
    $(document).ready(function () {
        ...
        var selectedStateId = '{{  old("state") ? old("state") : (isset($numberPlate->state_id) ? $numberPlate->state_id : null)  }}';
        var selectedCityId = '{{ old("city") ? old("city") : (isset($numberPlate->city_id) ? $numberPlate->city_id : null)  }}';
