...
@slot('title') Sloat Pricing  @endslot
@endcomponent
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header d-flex align-items-center border-0">
                <h5 class="card-title mb-0 flex-grow-1">All Sloat Pricing</h5>
                <div class="flex-shrink-0">
                    <a href="{{ route('slots-pricing.create')}}" class="btn btn-success"><i class="ri-add-line align-bottom me-1"></i> Add Sloat Pricing</a>
                </div>
            </div>
            ...
            <div class="card-body">
                    ...
                    <table class="table align-middle table-nowrap" id="customerTable">
                        <thead class="table-light text-muted">
                            <tr>
                                ...
                                <th class="sort" scope="col">Vehicle Model</th>
                                <th class="sort" scope="col">Action</th>
                            </tr>
                        </thead>
                        <!--end thead-->
                        <tbody class="list form-check-all">
                            @foreach ($slot_pricings as $slot_pricing)
                                <tr>
                                    <td scope="col">{{ request('page') !== null ? (request('page') - 1) * 10 + $loop->iteration  :  $loop->iteration}}</td>
                                    <td>{{ $slot_pricing->slot->start_time }}</td>
                                    <td>{{ $slot_pricing->state }}</td>
                                    <td>
                ...
                {!! $slot_pricings->withQueryString()->links('admin.paginate') !!}
