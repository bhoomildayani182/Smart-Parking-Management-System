    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header d-flex align-items-center border-0">
                <h5 class="card-title mb-0 flex-grow-1">State List</h5>
                <div class="flex-shrink-0">
                    <a href="{{ route('state.create')}}" class="btn btn-success"><i class="ri-add-line align-bottom me-1"></i> Add State</a>
            ...
            <div class="card-body">
                    ...
                    <table class="table align-middle table-nowrap" id="customerTable">
                        <thead class="table-light text-muted">
                            <tr>
                                ...
                                <th class="sort" scope="col">Country Name</th>
                        ...
                        <tbody class="list form-check-all">
                            @foreach ($states as $state)
                                <tr>
                                    ...
                                    <td class="status"><span class='badge text-uppercase {{ ($state->status == 'ACTIVE') ? 'badge-soft-success' : 'badge-soft-danger' }}'>{{ $state->status }}</span></td>
                                    <td>
                                        <div class="hstack gap-2">
                                            <a class="btn btn-sm btn-soft-danger remove-list" href="{{ route('state.delete', ['state' => $state->id]) }}"><i class="ri-delete-bin-5-fill align-bottom"></i></a>
                                            <a class="btn btn-sm btn-soft-info edit-list" href="{{ route('state.update', ['state' => $state->id]) }}"><i class="ri-pencil-fill align-bottom"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
                ...
                {!! $states->withQueryString()->links('admin.paginate') !!}
