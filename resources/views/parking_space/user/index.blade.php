        ...
        <div class="card">
            <div class="card-header d-flex align-items-center border-0">
                ...
                <div class="flex-shrink-0">
                    ...
                    <a href="{{ route('user.create')}}" class="btn btn-success"><i class="ri-add-line align-bottom me-1"></i> Add User</a>
            ...
            <div class="card-body">
                    ...
                    <table class="table align-middle table-nowrap" id="customerTable">
                        <thead class="table-light text-muted">
                            <tr>
                                ...
                                <th class="sort" scope="col">Is Active</th>
                        ...
                        <tbody class="list form-check-all">
                            @foreach ($users as $user)
                                <tr>
                                    ...
                                    <td>{{ $user->email }}</td>
                                    <td class="status"><span class='badge text-uppercase {{ ($user->is_active == 'ACTIVE') ? 'badge-soft-success' : 'badge-soft-danger' }}'>{{ $user->is_active }}</span></td>
                                    <td>
                                        <div class="hstack gap-2">
                                            ...
                                            {{ Form::close() }}
                                            <a class="btn btn-sm btn-soft-info edit-list" href="{{ route('user.edit', ['user' => $user->id]) }}"><i class="ri-pencil-fill align-bottom"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
                ...
                {!! $users->withQueryString()->links('admin.paginate') !!}
