    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header d-flex align-items-center border-0">
                <h5 class="card-title mb-0 flex-grow-1">City List</h5>
                <div class="flex-shrink-0">

                    <a href="{{ route('city.create')}}" class="btn btn-success"><i class="ri-add-line align-bottom me-1"></i> Add City</a>
            ...
            <div class="card-body">
                        ...
                        <tbody class="list form-check-all">
                            @foreach ($cities as $city)
                                <tr>
                                    ...
                                    <td class="status"><span class='badge text-uppercase {{ ($city->status == 'ACTIVE') ? 'badge-soft-success' : 'badge-soft-danger' }}'>{{ $city->status }}</span></td>
                                    <td>
                                        <div class="hstack gap-2">
                                            <a class="btn btn-sm btn-soft-danger remove-list" href="{{ route('city.delete', ['city' => $city->id]) }}"><i class="ri-delete-bin-5-fill align-bottom"></i></a>
                                            <a class="btn btn-sm btn-soft-info edit-list" href="{{ route('city.update', ['city' => $city->id]) }}"><i class="ri-pencil-fill align-bottom"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
                ...
                {!! $cities->withQueryString()->links('admin.paginate') !!}
