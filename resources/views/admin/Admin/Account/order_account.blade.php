...
@section('header_section')
    ...
    <nav aria-label="breadcrumb">
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Order Account</li>
        </ul>
    </nav>
@endsection
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="flex align-items-center list-user-action">
                                                    ...
                                                    <button type="submit" data-toggle="tooltip" data-placement="top" title="" data-original-title="Approve Amount" class="btn-table" value="{{ $user_account->id }}" name="order_amount_approve"><i class="ri-check-double-fill"></i></button>
                                                    ...
                                                    <a data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="{{ route("account.edit",$user_account->id) }}" ><i class="ri-pencil-line"></i></a>
